...
function buildPieces(w: number, h: number, rows: number, cols: number, seed: number): PieceGeom[] {
...
export function JigsawPuzzle({
  ...
  return (
    <div ref={hostRef} style={{ position: "relative", overflow: "visible", isolation: "isolate" }}>
        ...
        return (
          ...
          <div
            ...
            style={{
              ...
              transition: isDragging ? "none" : "transform 0.45s cubic-bezier(.2,.9,.25,1.3)",
